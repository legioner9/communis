...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_any_/any_.sh"
...
any_() {
    ...
    *)
        ...
        "${arr[1]}")
            ...
            xdg-open ${COMMUNIS_PATH}/Store/PDF/fedora-faq-ru.pdf&
            ;;

        "${arr[2]}")
            echo -e "${CYAN}---${arr[2]}---${NORMAL}" #started functions
            cd_h $TSH_book_path
            xdg-open book.pdf&
            ;;
