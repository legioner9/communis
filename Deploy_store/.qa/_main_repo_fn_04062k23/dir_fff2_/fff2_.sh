...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_fff2_/fff2_.sh"
...
${NORMAL}"
    ...
    #{see_cntl}
    exit_err_fff2_() { #* $1 error message
        local arg1="$1"
        unset_autoargs_fff2_
    ...
    # >${FN_OUT_DIR}/com_fff2_.res
    # COMMAND &>>${FN_OUT_DIR}/com_fff2_.res
    # if [ $? -ne 0 ]; then
    #     if [ 1 -eq ${verbose} ]; then
    #         cat ${FN_OUT_DIR}/com_fff2_.res
    #     fi
    #     #? runtime error allowed locally
    #     error_allowed_locall_string="STRING"
    #     if cat ${FN_OUT_DIR}/COMMAND_fff2_.res | is_rl_siev_and ${error_allowed_locall_string}; then
    #         continue
    #     else
    #         exit_err_fff2_ "runtime error:: COMMAND ${addr}"
    #     fi
    # fi
    #! amount args
