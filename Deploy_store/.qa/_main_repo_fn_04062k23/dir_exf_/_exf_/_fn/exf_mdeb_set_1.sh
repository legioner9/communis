#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_exf_/_exf_/_fn/exf_mdeb_set_1.sh"
...
exf_mdeb_set_1() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_exf_/_exf_/_fn/exf_mdeb_set_1.sh)
...
${NORMAL}"
    ...
    # amount_arg $# 1 1
    cd ${PATH_MAIN_REPO_FN_DIR}/dir_exf_/_exf_/_fn/test_dir
    exf_ ls
    #{body_fn}
}
