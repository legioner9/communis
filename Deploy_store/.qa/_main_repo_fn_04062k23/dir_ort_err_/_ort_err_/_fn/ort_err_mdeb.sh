#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_ort_err_/_ort_err_/_fn/ort_err_mdeb.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_ort_err_/_ort_err_/_fn/ort_err_mdeb.sh)
