...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_prn_list_2_/prn_list_2_.sh"
...
'
            ...
            if [ 2 -ne $amount_part ]; then
                qq_exit "$FNN:: in file:$1 delim: $2 in not_nul line: $line , amount_part = $amount_part != 2"
            fi
