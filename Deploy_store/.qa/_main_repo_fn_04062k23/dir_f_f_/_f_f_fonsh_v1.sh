...
f_f_fonsh_() {
    ...
    *)
        ...
        rts_fn=${PATH_MAIN_REPO_FN_DIR}

        cr_f_ "$PWD/dir_$1/$1.sh" --vi0 ${rts_fn} --vr0 {rts_fn}
        upg_path_ "$PWD/dir_$1/$1.sh"

        #* work in _debug >>>>>>>>>>
        wrp_fifs1_ cd ${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_debug/v1 -d1
        cr_sh_ deb_1.sh
        wrp_fifs1_ cd ${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_debug/self_tst -d1
        cr_sh_ self_tst_1.sh
        wrp_fifs1_ cd ${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_debug -d1
        cr_sh_ mdeb.sh

        #? _fn/$1_mdeb.sh
        file_path=${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_fn/$1mdeb.sh
        ...
        #? _fn/$1_mdeb_set_1.sh
        file_path=${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_fn/$1mdeb_set_1.sh
        ...
        file_path=${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_debug/self_tst/self_tst_1.sh
        ...
        edit_ "${PATH_MAIN_REPO_FN_DIR}/dir_$1"

        . ${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_debug/self_tst/self_tst_1.sh
        #* work in _debug <<<<<<<<<<

        #* work in extst >>>>>>>>>>
        wrp_fifs1_ cd ${PATH_MAIN_REPO_FN_DIR}/dir_$1/ -d1
        ...
        #* work in _default >>>>>>>>>>
        wrp_fifs1_ cd ${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_default -d1
        cr_sh_ default_deb.sh

        file_path=${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_default/default_deb.sh
