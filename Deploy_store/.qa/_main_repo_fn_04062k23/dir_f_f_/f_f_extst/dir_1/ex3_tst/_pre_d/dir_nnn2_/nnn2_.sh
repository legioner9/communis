...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/f_f_extst/dir_1/ex3_tst/_res_d/dir_nnn2_/nnn2_.sh"
...
local FN_DIR=${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/f_f_extst/dir_1/ex3_tst/_res_d #? contane dir of function
local FLN=$0
local ARGS=($@)
local NARGS=$#
local ARGS1=$1
