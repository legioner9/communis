...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_fed_/fed_.sh"
...
fed_() {
    ...
    *)
        ...
        arr=()
        res=()
        arr+=("read fedora-faq-ru.pdf")
        res+=("xdg-open ${COMMUNIS_PATH}/Store/PDF/fedora-faq-ru.pdf")
        arr+=("All be saved from Fedora.ru (fed_heap_)")
        res+=("fed_heap_")
        # arr+=("eeeeeeeee")
        # res+=("rrrrrrrr")
        # arr+=("eeeeeeeee")
