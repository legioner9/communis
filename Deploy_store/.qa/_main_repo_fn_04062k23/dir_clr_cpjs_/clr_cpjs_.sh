...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_clr_cpjs_/clr_cpjs_.sh"
...
clr_cpjs_() {
    ...
    *)
        ...
        for init_path_tail in $(f2e "${PATH_MAIN_REPO_FN_DIR}"/dir_"$FNN"/"$FNN".lst); do
            init_path_full=/home/st/$init_path_tail
            echo -e "${GREEN}\$init_path_full = $init_path_full${NORMAL}" #print variable
            echo -e "${BLUE}--- rmr_o_d $init_path_full ---${NORMAL}" #sistem info mesage
            rmr_o_d $init_path_full
        done
