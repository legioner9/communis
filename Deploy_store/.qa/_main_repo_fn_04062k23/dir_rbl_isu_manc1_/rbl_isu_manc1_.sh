...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_rbl_isu_manc1_/rbl_isu_manc1_.sh"
...
rbl_isu_manc1_() {
    ...
    *)
        ...
        rm -rf ${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MAN1/contents
        mkdir_h ${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MAN1/contents
        ...
        for tail_path in $(f2e ${PATH_MAIN_REPO_FN_DIR}/dir_rbl_isu_mancc_/rbl_isu_mancc_.list); do
            ...
            for isu_path in $(drp2e /home/st/$tail_path isu); do
                ...
                path_content_file=${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MAN1/contents/$(prs_f -n $isu_path).cnt
