        ...
        for hfile in $(d2e "$hdir"); do
            ...
            for sname in $(f2e "$hdir/$hfile" @); do
                ...
                if [ ! -f "$spath" ]; then
                    ...
                    echo "cp ${PATH_MAIN_REPO_FN_DIR}/dir_cr_man_h_unix_/_cr_man_h_unix_/_tml/doc_file/file_struct.tml $spath"
                    cp "/home/st"/${PATH_MAIN_REPO_FN_DIR}/dir_cr_man_h_unix_/_cr_man_h_unix_/_tml/doc_file/file_struct.tml "$spath"
