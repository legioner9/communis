...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_cr_docman_from_file_/cr_docman_from_file_.sh"
...
cr_docman_from_file_() {
    ...
    *)
        ...
        path_md="$PPWD"/_cr_docman_from_file_.md
        ...
        arr+=("cr_unix_man")
        res+=("cr_unix_man $(pwd)")
        arr+=("cr_unix_man_from_listsh")
        res+=("cr_unix_man_from_listsh")
        # arr+=("eeeeeeeee")
        # res+=("ttttttttt")
        # arr+=("eeeeeeeee")
        # res+=("ttttttttt")
