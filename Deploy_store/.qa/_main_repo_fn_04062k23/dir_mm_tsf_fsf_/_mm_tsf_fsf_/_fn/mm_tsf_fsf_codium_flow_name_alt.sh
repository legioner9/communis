...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_mm_tsf_fsf_/_mm_tsf_fsf_/_fn/mm_tsf_fsf_codium_flow_name_alt.sh"
...
mm_tsf_fsf_codium_flow_name_alt() {
    ...
    d_name=$(dirname "/home/st"/${PATH_MAIN_REPO_FN_DIR}/dir_mm_tsf_fsf_/_mm_tsf_fsf_/_fn/mm_tsf_fsf_codium_flow_name_alt.sh)
