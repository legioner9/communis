#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_puml_/_puml_/_fn/puml_mdeb.sh"
...
puml_mdeb() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_puml_/_puml_/_fn/puml_mdeb.sh)
...
${NORMAL}"
    ...
    arr+=("leave menu")
    res+=("echo bye)))")
    arr+=("${FNN}_set_1: -_drawing -verbose ")
    res+=("${FNN}_set_1")
    #{arr_res}
    # arr+=("aaaaaaaaa")
    # res+=("bbbbbbbbb")
