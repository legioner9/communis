#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_puml_/_puml_/_fn/puml_mdeb_set_1.sh"
...
puml_mdeb_set_1() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_puml_/_puml_/_fn/puml_mdeb_set_1.sh)
