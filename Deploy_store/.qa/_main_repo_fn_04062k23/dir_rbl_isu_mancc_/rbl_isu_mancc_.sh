...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_rbl_isu_mancc_/rbl_isu_mancc_.sh"
...
rbl_isu_mancc_() {
    ...
    if [ "dir" == "$1" ]; then
        edit_ ${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MANC/contents
        return 0
    fi
    ...
    *)
        ...
        rm -rf ${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MANC/contents
        mkdir_h ${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MANC/contents

        for tail_path in $(f2e ${PATH_MAIN_REPO_FN_DIR}/dir_rbl_isu_mancc_/rbl_isu_mancc_.list); do
            echo -e "${GREEN}\$tail_path = $tail_path${NORMAL}" #print variable

            for isu_path in $(drp2e /home/st/$tail_path isu); do

                path_content_file=${PATH_MAIN_REPO_FN_DIR}/dir_c_/_c_/_man/nbase/MANC/contents/$(prs_f -n $isu_path).cnt
