...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_cr_pj_c_simp_/cr_pj_c_simp_.sh"
...
cr_pj_c_simp_() {
    ...
    *)
        ...
        path_patch=${DDD}/_sh/_patch/patch_1.sh
        ...
        echo -e "${BLUE}--- cr_f_ ${path_rbl} --vi0 ${path_patch} --vr0 {path_patch} ---${NORMAL}" #sistem info mesage
        cr_f_ "${path_rbl}" --vi0 ${path_patch} --vr0 {path_patch}
