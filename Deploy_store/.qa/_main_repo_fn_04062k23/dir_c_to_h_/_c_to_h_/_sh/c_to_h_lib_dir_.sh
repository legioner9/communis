...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_c_to_h_/_c_to_h_/_sh/c_to_h_lib_dir_.sh"
...
c_to_h_lib_dir_() {                                      # $1 - dir lib clang
    ...
    if [ "man" == "$1" ]; then
        d_name=$(dirname "/home/st"/${PATH_MAIN_REPO_FN_DIR}/dir_c_to_h_/_c_to_h_/_sh/c_to_h_lib_dir_.sh)
    ...
    for item in $(d_a_stl "c"); do
        ...
        if [ -f "$1/$item" ] && [ "$1/$name".h -ot "$1/$name".c ]; then
            ...
            rm "$1/$name".fns
            cp_h "${PATH_MAIN_REPO_FN_DIR}/dir_c_to_h_/_c_to_h_/_tml/c_h.tml" "$1/$name".h
...
# c_to_h_lib_dir_ ${PATH_MAIN_REPO_FN_DIR}/dir_c_to_h_/_c_to_h_/_examps/pr_a
