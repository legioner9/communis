...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_grg_fn_/grg_fn_.sh"
...
grg_fn_() {
    ...
    mst_dir=${PATH_MAIN_REPO_FN_DIR}/dir_${name_fn_grg_fn_}
    mst_name=${name_fn_grg_fn_}

    qq_pause "(${mst_name}) create !!! in (${PATH_MAIN_REPO_FN_DIR}/dir_${mst_name}/) file (${mst_name}.sh) dir (_${mst_name}) ?" "${filename}" "{$LINENO}"
