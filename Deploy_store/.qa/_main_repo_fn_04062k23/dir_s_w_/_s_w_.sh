...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_s_w_/s_w_.sh"
...
s_w_() {
    ...
    *)
        ...
        PF=${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/_f_f_/_man
        ...
        if [ -n "$find_files" ]; then
            ...
            for file_name in $find_files; do
                ...
                for gre in $(grep -n "^#" $file_name); do
            ...
            echo -e "${BLUE}---find_files not found .man---${NORMAL}" #sistem info mesage
        fi
        #!function body======================
        #!function body===============================================
        #!function body===================================================================
