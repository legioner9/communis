...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_cr_uperr2_/cr_uperr2_.sh"
...
cr_uperr2_() {
    ...
    *)
        ...
        # USE cr_uperr2_() -echo -deb
        echo_cr_uperr2_=0
        deb_cr_uperr2_=0
        garg_ ${FUNCNAME[0]} $@ 1>/dev/null
        echo_deb_ $echo_cr_uperr2_ "cntl echo_deb_ mode in ${FUNCNAME[0]}"
        if [ $deb_cr_uperr2_ -eq 1 ]; then
