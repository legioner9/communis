...
# filename="$PATH_OS/.qa/menus/_set_menu/_mm_flow_/_mm_0_start_sys_/fs_.sh"
filename="$PWD/fs_.sh"
...
fs_(){
    echo -e "${CYAN}---fs_() $*---${NORMAL}" #started functions
    
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/for_menu/_fs_"
