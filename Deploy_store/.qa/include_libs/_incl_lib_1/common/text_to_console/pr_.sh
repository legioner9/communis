...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/pr_"
...
pr_(){
    echo -e "${CYAN}---pr_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_pr_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_pr_/"
