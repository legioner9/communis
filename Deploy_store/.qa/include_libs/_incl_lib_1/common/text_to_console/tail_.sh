...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/tail_"
...
tail_(){
    echo -e "${CYAN}---tail_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_tail_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_tail_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu tail_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
