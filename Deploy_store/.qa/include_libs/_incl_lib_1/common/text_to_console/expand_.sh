...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/expand_"
...
expand_(){
    echo -e "${CYAN}---expand_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_expand_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_expand_/_man_1"
