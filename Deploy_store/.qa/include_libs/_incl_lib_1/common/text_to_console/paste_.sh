...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/paste_"
...
paste_(){
    echo -e "${CYAN}---paste_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_paste_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_paste_/"
    
    arr=()
    res=()
    arr+=("leave menu paste_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
