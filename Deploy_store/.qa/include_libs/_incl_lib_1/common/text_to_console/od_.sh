...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/od_"
...
od_(){
    echo -e "${CYAN}---od_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_od_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_od_/_man_1"
