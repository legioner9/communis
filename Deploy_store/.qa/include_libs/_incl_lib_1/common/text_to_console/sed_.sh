...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/sed_"
...
sed_(){
    echo -e "${CYAN}---sed_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_sed_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_sed_/"
