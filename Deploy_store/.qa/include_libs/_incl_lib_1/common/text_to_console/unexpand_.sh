...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/unexpand_"
...
unexpand_(){
    echo -e "${CYAN}---unexpand_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_unexpand_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_unexpand_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu unexpand_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
