...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/uniq_"
...
uniq_(){
    echo -e "${CYAN}---uniq_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_uniq_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_uniq_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu uniq_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
