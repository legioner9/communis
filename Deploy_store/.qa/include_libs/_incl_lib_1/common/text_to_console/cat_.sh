...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/cat_"
...
cat_(){
    echo -e "${CYAN}---cat_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_cat_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_cat_/"
