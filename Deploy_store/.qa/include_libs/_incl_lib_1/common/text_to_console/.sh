...
filename="$HOME/.qa/include_libs/_incl_lib_1/common/text_to_console/"
...
(){
    echo -e "${CYAN}---() $*---${NORMAL}" #started functions
 
    c_up "$HOME/.qa/include_libs/_incl_lib_1/common/text_to_console/_/"
    path_man_1="$HOME/.qa/include_libs/_incl_lib_1/common/text_to_console/_/_man_1"
