...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/less_"
...
less_(){
    echo -e "${CYAN}---less_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_less_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_less_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu less_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
