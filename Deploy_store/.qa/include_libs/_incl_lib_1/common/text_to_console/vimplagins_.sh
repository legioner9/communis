...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/vimplagins_"
...
vimplagins_(){
    echo -e "${CYAN}---vimplagins_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_vimplagins_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_vimplagins_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu vimplagins_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
