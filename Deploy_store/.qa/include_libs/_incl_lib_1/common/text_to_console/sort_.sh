...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/sort_"
...
sort_(){
    echo -e "${CYAN}---sort_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_sort_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_sort_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu sort_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
