...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/vim_"
...
vim_(){
    echo -e "${CYAN}---vim_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_vim_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_vim_/_man_1"
