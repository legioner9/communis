...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/tr_"
...
tr_(){
    echo -e "${CYAN}---tr_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_tr_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_tr_/_man_1"
