...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/nl_"
...
nl_(){
    echo -e "${CYAN}---nl_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_nl_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_nl_/_man_1"
