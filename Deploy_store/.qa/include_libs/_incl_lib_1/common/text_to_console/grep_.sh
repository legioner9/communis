...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/grep_"
...
grep_(){
    echo -e "${CYAN}---grep_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_grep_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_grep_/"
    
    arr=()
    res=()
    arr+=("leave menu grep_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
