...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/join_"
...
join_(){
    echo -e "${CYAN}---join_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_join_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_join_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu join_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
