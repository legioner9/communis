...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/read_"
...
read_(){
    echo -e "${CYAN}---read_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_read_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_read_/_man_1"
    
    arr=()
    res=()
    arr+=("leave menu read_")
    res+=("echo bye)))")
    arr+=("man_1 - man ru")
    res+=("gvim -v $path_man_1")
