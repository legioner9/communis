...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/cut_"
...
cut_(){
    echo -e "${CYAN}---cut_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_cut_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_cut_/_man_1"
