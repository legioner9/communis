...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/wc_"
...
wc_(){
    echo -e "${CYAN}---wc_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_wc_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_wc_/_man_1"
