...
filename="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/var_"
...
var_(){
    echo -e "${CYAN}---var_() $*---${NORMAL}" #started functions
 
    c_up "$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_var_/"
    path_man_1="$PATH_OS/.qa/include_libs/_incl_lib_1/common/text_to_console/_var_/_man_1"
