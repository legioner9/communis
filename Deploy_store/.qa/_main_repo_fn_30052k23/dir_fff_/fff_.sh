...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_fff_/fff_.sh"
...
${NORMAL}"
    ...
    # >${FN_OUT_DIR}/com_fff_.res
    # COMMAND &>>${FN_OUT_DIR}/com_fff_.res
    # if [ $? -ne 0 ]; then
    #     if [ 1 -eq ${verbose} ]; then
    #         cat ${FN_OUT_DIR}/com_fff_.res
    #     fi
    #     #? runtime error allowed locally
    #     error_allowed_locall_string="STRING"
    #     if cat ${FN_OUT_DIR}/COMMAND_fff_.res | is_rl_siev_and ${error_allowed_locall_string}; then
    #         continue
    #     else
    #         exit_err_fff_ "runtime error:: COMMAND ${addr}"
    #     fi
    # fi
    #! amount args
