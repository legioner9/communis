...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_iff_/_iff_/_debug/in_exl/check.sh"
...
cd ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_iff_/_iff_/_debug/in_exl
