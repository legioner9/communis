...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_asm_/_asm_/_man/hello_world/src/build_start.sh"
...
#-------------------------------------
#-------------------------------
as hello_worlbd.s -o hello_worlbd.o && ld hello_worlbd.o && ./a.out
#{body}
#-------------------------------
#-------------------------------------
#----------------------------------------------------------------------
