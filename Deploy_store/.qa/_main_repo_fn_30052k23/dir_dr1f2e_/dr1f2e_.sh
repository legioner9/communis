...
RETURN: stdout fpath 
ERROR: -qq_exit
DEBUG: . ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_dr1f2e_/_dr1f2e_/_debug/v2/deb_1.sh
EXAMP: dr1f2e_ \${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_dr1f2e_/_dr1f2e_/_debug/v2/d0 -qq_exit${NORMAL}"
        return 0
    fi
    #{ctrl_args_reciver}
