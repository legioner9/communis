...
mancc_() {
    ...
    *)
        ...
        manpath=$HOME/$(cat ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mancc_/mancc_copy.list)
        ...
        mancc_list_manpath_() {
            for path in $(f2e ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mancc_/mancc_.list); do
                # echo "$HOME/$path" #start files
                mancc_manpath_ $HOME/$path
            done
        ...
        # echo -e "${HLIGHT}--- mancc_manpath_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MANC ---${NORMAL}" #start files
        # mancc_manpath_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MANC
