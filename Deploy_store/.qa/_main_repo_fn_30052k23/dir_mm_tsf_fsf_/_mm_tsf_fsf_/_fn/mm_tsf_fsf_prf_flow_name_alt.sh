...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mm_tsf_fsf_/_mm_tsf_fsf_/_fn/mm_tsf_fsf_prf_flow_name_alt.sh"
...
mm_tsf_fsf_prf_flow_name_alt() {
    ...
    d_name=$(dirname ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mm_tsf_fsf_/_mm_tsf_fsf_/_fn/mm_tsf_fsf_prf_flow_name_alt.sh)
