...
filename="$PATH_FN/dir_mm_tsf_fsf_/mm_tsf_fsf_.sh"
...
MAIN: menu with tsf_fsf_ standart flow 
NAME: ${FNN}()
ARGS: 
\$1
CNTLS:
...
EXAMP:${NORMAL}"
    ...
    arr+=("bcp codium toshiba_ext alt")
    res+=("mm_tsf_fsf_codium_bcp_toshiba_ext_alt")
    arr+=("dpl codium toshiba_ext alt")
    res+=("mm_tsf_fsf_codium_dpl_toshiba_ext_alt")
    ...
    arr+=("bcp codium tosh alt")
    res+=("mm_tsf_fsf_codium_bcp_tosh_alt")
    arr+=("dpl codium tosh alt")
    res+=("mm_tsf_fsf_codium_dpl_tosh_alt")
    ...
    res+=("cp -rfuv ${PATH_TOSHIBA_EXT}/ZENNO/.  ${PATH_CURR_REPO}/Nota")
    # arr+=("aaaaaaaaa")
    # res+=("bbbbbbbbb")
    # arr+=("aaaaaaaaa")
    # res+=("bbbbbbbbb")
