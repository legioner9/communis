...
filename="$PATH_FN/dir_magic_nm_/magic_nm_.sh"
...
magic_nm_() {
    ...
    *)
        ...
        "edit")
            ...
            # if ! gvim -v "$PATH_OS/.qa/main_repo_fn/_config/agno_tag"; then
            #     code "$PATH_OS/.qa/main_repo_fn/_config/agno_tag"
            # fi
            fs_ "$PATH_OS/.qa/main_repo_fn/_config/agno_tag"
            magic_nm_ "$1"
        ...
        "vim")
            ...
            if_d_s "$ORIGO_DIR"
            # gvim -v "$ORIGO_DIR"
            # if ! gvim -v "$PATH_FN/dir_$1/_$1/_man"; then
            #     code "$PATH_FN/dir_$1/_$1/_man"
            # fi
            fs_ "$PATH_FN/dir_$1/"
        ...
        "man")
            ...
            if_d_s "$PATH_FN/dir_$1/_$1/_man"
            # man_is "$PATH_FN/dir_$1/_$1/_man"
            fs_ "$PATH_FN/dir_$1/_$1/_man"
