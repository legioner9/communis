...
filename="$PATH_FN/dir_ce_/ce_.sh"
...
ce_() {
    ...
    *)
        ...
        local match=$2
        local flag_search=1
        local cexec_path=${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_exec
        local dilectus
...
${NORMAL}" #sistem info mesage
            ...
            code ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_exec
        else
