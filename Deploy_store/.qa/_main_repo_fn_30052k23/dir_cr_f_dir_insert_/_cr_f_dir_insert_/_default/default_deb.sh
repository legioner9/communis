...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_cr_f_dir_insert_/_cr_f_dir_insert_/_default/default_deb.sh"
...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_cr_f_dir_insert_/_cr_f_dir_insert_/_default/z_file"

cr_f_dir_insert_ --name ${filename} --dir_insert ${PATH_INSERT_DIR}/obs_quis_
# cr_f_ z_file --vi0 '\$HOME' --vr0 "${HOME}"
