...
#-------------------------------
rr_
# dr1f2e_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_dr1f2e_/_dr1f2e_/_debug/v2/d0 -qq_exit
echo $?
dr1f2e_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_dr1f2e_/_dr1f2e_/_debug/v2/d0x -qq_exit
echo $?
#{body}
#-------------------------------
#-------------------------------------
