...
filename="$PATH_FN/dir_fifs2_bash_pref_dist_src_/fifs2_bash_pref_dist_src_.sh"
    ...
    if [ "-h" == "$1" ]; then
        echo -e "${CYAN} ${FUNCNAME[0]}() help: 
            ...
            ARGS: 
                ...
                \$3: src (-f1, -d1)
            TAGS:
            FLOW:${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_cp__/_cp__with_ptototype_fifs2.sh${NORMAL}"
        return 0
    fi
