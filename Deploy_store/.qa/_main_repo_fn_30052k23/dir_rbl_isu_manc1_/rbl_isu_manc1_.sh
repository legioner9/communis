...
filename="$PATH_FN/dir_rbl_isu_manc1_/rbl_isu_manc1_.sh"
...
rbl_isu_manc1_() {
    ...
    *)
        ...
        rm -rf ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MAN1/contents
        mkdir_h ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MAN1/contents
        ...
        for tail_path in $(f2e ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_rbl_isu_mancc_/rbl_isu_mancc_.list); do
            ...
            for isu_path in $(drp2e $HOME/$tail_path isu); do
                ...
                path_content_file=${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MAN1/contents/$(prs_f -n $isu_path).cnt
