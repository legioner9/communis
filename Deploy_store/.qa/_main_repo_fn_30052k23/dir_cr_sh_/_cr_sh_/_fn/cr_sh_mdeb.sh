#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_cr_sh_/_cr_sh_/_fn/cr_sh_mdeb.sh"
...
cr_sh_mdeb() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_cr_sh_/_cr_sh_/_fn/cr_sh_mdeb.sh)
...
${NORMAL}"
    ...
    arr+=("leave menu")
    res+=("echo bye)))")
    arr+=("cr_sh_mdeb_set1 create _tmp.sh and check with args")
    res+=("cr_sh_mdeb_set1")
    # arr+=("aaaaaaaaa")
    # res+=("bbbbbbbbb")
    # arr+=("aaaaaaaaa")
