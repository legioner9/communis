...
filename="$PATH_FN/dir_mm_rbl_all_/mm_rbl_all_.sh"
...
mm_rbl_all_() {
    ...
    if [ "1" == "$1" ]; then
        rbl_cat_ext_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_rbl_cat_ext_/_rbl_cat_ext_/_file_with_dirs_for_cat/word_c_libs.dirs word $grep_mm_rbl_all_
        return 0
    fi

    if [ "2" == "$1" ]; then
        rbl_cat_ext_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_rbl_cat_ext_/_rbl_cat_ext_/_file_with_dirs_for_cat/cexa_c_mipt.dirs cexa $grep_mm_rbl_all_
        return 0
    fi

    if [ "3" == "$1" ]; then
        rbl_cat_ext_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_rbl_cat_ext_/_rbl_cat_ext_/_file_with_dirs_for_cat/cexa_c_nbase.dirs cexa $grep_mm_rbl_all_
        return 0
    fi

    if [ "4" == "$1" ]; then
        rbl_cat_ext_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_rbl_cat_ext_/_rbl_cat_ext_/_file_with_dirs_for_cat/cexa_c_fpmi.dirs cexa $grep_mm_rbl_all_
        return 0
    fi
