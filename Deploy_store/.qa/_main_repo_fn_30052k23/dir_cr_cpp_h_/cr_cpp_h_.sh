...
filename="$PATH_FN/dir_cr_cpp_h_/cr_cpp_h_.sh"
...
cr_cpp_h_() {
    ...
    *)
        ...
        echo -e "${ULINE}cp_h "$PATH_FN"/dir_cr_cpp_h_/_cr_cpp_h_/_tml/init.tml "$PPWD"/"$file_name".h${NORMAL}" #repit commands
        cp_h "$PATH_FN"/dir_cr_cpp_h_/_cr_cpp_h_/_tml/init.tml "$PPWD"/"$file_name".h
