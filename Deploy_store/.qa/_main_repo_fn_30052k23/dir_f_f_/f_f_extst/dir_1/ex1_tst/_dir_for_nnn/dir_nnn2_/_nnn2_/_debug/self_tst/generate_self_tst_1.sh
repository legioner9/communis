...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_f_f_/f_f_extst/dir_1/ex1_tst/_dir_for_nnn/dir_nnn2_/_nnn2_/_debug/self_tst/generate_self_tst_1.sh"
