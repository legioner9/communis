...
f_f_arg_() {
    ...
    # wrp2_ mv --_xxf "$PATH_FN/dir_${name_fn_}/_${name_fn_}/_config/mane_.tag" --_xnf "$PATH_FN/dir_${name_fn_}/_${name_fn_}/_config/mane_${name_fn_}.tag"
    # wrp2_ mv --_xxf ${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/_f_f_/_debug/v1/dir_fns/dir_fff_arg_/_fff_arg_/_config/mane_.tag --_xnf "$PATH_FN/dir_${name_fn_}/_${name_fn_}/_config/mane_${name_fn_}.tag"
