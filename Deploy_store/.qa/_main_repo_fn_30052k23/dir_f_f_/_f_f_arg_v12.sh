...
f_f_arg_() {
    ...
    cr_f_dir_insert_ --name ${src_fn_file} --dir_insert ${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/1
    cr_f_dir_insert_ --name ${src_fn_file} --dir_insert ${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/2

    #! ${ORIGO_DIR}/_f_f_/_insert_files -> ${PATH_INSERT_DIR}/f_f_/_fn_fff_sh

    # # ctrl_args
    # ctrl_args_inserter=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/ctrl_args.inserter
    # cr_f_ ${src_fn_file} --fi0 ${ctrl_args_inserter} --fr0 {ctrl_args_reciver}

    # # init_body
    # init_body_inserter=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/init_body.inserter
    # cr_f_ ${src_fn_file} --fi1 ${init_body_inserter} --fr1 {init_body_reciver}

    # # def_const
    # def_const_inserter=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/def_const.inserter
    # cr_f_ ${src_fn_file} --fi2 ${def_const_inserter} --fr2 {def_const_reciver}

    # # cntl_default
    # cntl_default=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/cntl_default.inserter
    # cr_f_ ${src_fn_file} --fi0 ${cntl_default} --fr0 {cntl_default}

    # # cntl_help
    # cntl_help=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/cntl_help.inserter
    # cr_f_ ${src_fn_file} --fi2 ${cntl_help} --fr2 {cntl_help}

    # # garg
    # garg=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/garg.inserter
    # cr_f_ ${src_fn_file} --fi0 ${garg} --fr0 {garg}

    # # ptr_if
    # ptr_if=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/ptr_if.inserter
    # cr_f_ ${src_fn_file} --fi0 ${ptr_if} --fr0 {ptr_if}

    # # see_cntl
    # see_cntl=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/see_cntl.inserter
    # cr_f_ ${src_fn_file} --fi0 ${see_cntl} --fr0 {see_cntl}

    # # def_exit
    # def_exit=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/def_exit.inserter
    # cr_f_ ${src_fn_file} --fi0 ${def_exit} --fr0 {def_exit}

    # # hints
    # hints=${PATH_INSERT_DIR}/f_f_/_fn_fff_sh/hints.inserter
