#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/_f_f_/_debug/v1/dir_fns/dir_fff_deb_/_fff_deb_/_fn/fff_deb_mdeb_set_1.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/_f_f_/_debug/v1/dir_fns/dir_fff_deb_/_fff_deb_/_fn/fff_deb_mdeb_set_1.sh)
