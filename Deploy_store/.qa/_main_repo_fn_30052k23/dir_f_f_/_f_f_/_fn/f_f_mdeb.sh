#!/bin/bash
#. "$HOME/.bashrc"
filename="${PATH_COMMUNIS}/Deploy_store/.qa/main_repo_fn/dir_f_f_/_f_f_/_fn/f_f_mdeb.sh"
...
f_f_mdeb() {
    ...
    d_name=$(dirname ${PATH_COMMUNIS}/Deploy_store/.qa/main_repo_fn/dir_f_f_/_f_f_/_fn/f_f_mdeb.sh)
...
${NORMAL}"
    ...
    f_f_mdeb_set1() {
        rr_
        . ${PATH_COMMUNIS}/Deploy_store/.qa/main_repo_fn/dir_f_f_/_f_f_/_debug/v1/start.sh
        rr_
        fff_ _mdeb
    }
    ...
    f_f_mdeb_set3() {
        rr_
        . ${PATH_COMMUNIS}/Deploy_store/.qa/main_repo_fn/dir_f_f_/_f_f_/_debug/v1/start_2.sh
        rr_
