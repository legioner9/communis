...
${NORMAL}"
    ...
    [[ 1 -eq ${verbose} ]] || echo -e "${HLIGHT}--- java -jar ${PATH_COMMUNIS}/Store/PlantUml/plant_jar/plantuml.jar ${ptr_path} ---${NORMAL}" #start files

    java -jar ${PATH_COMMUNIS}/Store/PlantUml/plant_jar/plantuml.jar ${ptr_path} >${path_png}
