...
filename="$PATH_FN/dir_rbl_isu_mancc_/rbl_isu_mancc_.sh"
...
rbl_isu_mancc_() {
    ...
    if [ "dir" == "$1" ]; then
        edit_ ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MANC/contents
        return 0
    fi
    ...
    *)
        ...
        rm -rf ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MANC/contents
        mkdir_h ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MANC/contents

        for tail_path in $(f2e ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_rbl_isu_mancc_/rbl_isu_mancc_.list); do
            echo -e "${GREEN}\$tail_path = $tail_path${NORMAL}" #print variable

            for isu_path in $(drp2e $HOME/$tail_path isu); do

                path_content_file=${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/MANC/contents/$(prs_f -n $isu_path).cnt

                if [ ! -f $path_content_file ]; then
                    touch $path_content_file
                fi

                echo -e "${GREEN}\$isu_path = $isu_path${NORMAL}" #print variable

                echo file://"$isu_path" >>$path_content_file
