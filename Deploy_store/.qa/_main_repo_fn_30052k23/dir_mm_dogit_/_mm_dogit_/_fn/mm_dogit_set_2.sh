...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mm_dogit_/_mm_dogit_/_fn/mm_dogit_set_2.sh"
...
mm_dogit_set_2() {
    ...
    d_name=$(dirname ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mm_dogit_/_mm_dogit_/_fn/mm_dogit_set_2.sh)
