...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_mm_dogit_/_mm_dogit_/_fn/mm_dogit_dlb_name.sh"
...
mm_dogit_dlb_name() {
    ...
    d_name=$(dirname ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_mm_dogit_/_mm_dogit_/_fn/mm_dogit_dlb_name.sh)
    ...
    exl_file="${PATH_EXL_DIR}/git/dogit_dlb_name.exl"
