...
[0;36m---qq_pause() $.1=be return 1 <- Fail: return errno: 1 from:  in fn: exl_, with_args: --list ${COMMUNIS_PATH}/Deploy_store/.qa/.exl/git/dogit_carppafcp_name.exl , filename: ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_exl_/exl_.sh, line: 0 $.2= $.3=---[0m
[0;31m---message: be return 1 <- Fail: return errno: 1 from:  in fn: exl_, with_args: --list ${COMMUNIS_PATH}/Deploy_store/.qa/.exl/git/dogit_carppafcp_name.exl , filename: ${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_exl_/exl_.sh, line: 0---[0m
[0;31m---file: ---[0m
[0;31m---line: ---[0m
