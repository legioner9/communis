#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_up_down_/_up_down_/_fn/up_down_mdeb.sh"
...
up_down_mdeb() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_up_down_/_up_down_/_fn/up_down_mdeb.sh)
