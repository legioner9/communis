#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_up_down_/_up_down_/_fn/up_down_mdeb_set_1.sh"
...
up_down_mdeb_set_1() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_up_down_/_up_down_/_fn/up_down_mdeb_set_1.sh)
