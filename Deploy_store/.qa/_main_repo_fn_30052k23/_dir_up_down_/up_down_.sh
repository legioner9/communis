...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_up_down_/up_down_.sh"
...
#{see_cntl}
exit_err_up_down_() { #* $1 error message
local arg1="$1"
unset_autoargs_up_down_
...
# >${FN_OUT_DIR}/com_up_down_.res
# COMMAND &>>${FN_OUT_DIR}/com_up_down_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_up_down_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_up_down_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_up_down_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
