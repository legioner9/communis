...
filename="$PATH_FN/dir_bckp_list_/bckp_list_.sh"
            ...
            if [ 1 -eq "$count" ]; then
                ...
                if [ "$1" == "-b" ]; then
                    ...
                    if [ -e "$dest/$file_src" ]; then
                        ...
                        # echo -e "${BLUE}--- cp -rf $HOME/$dest/$file_src $HOME/$dir_src ---${NORMAL}" #sistem info mesage
                    ...
                    # echo -e "${HLIGHT}--- cp -ru --backup=t $HOME/$dest/$file_src $HOME/$dir_src ---${NORMAL}"
                    # sth_fd_ "$HOME/$src" 3
                    # cp -ru "$HOME/$dest/$file_src" "$HOME/$dir_src"
                else
