...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_dotnet_/_dotnet_/_sh/dotnet_init_flow.sh"
...
dotnet_init_flow() {
    ...
    res+=("${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_dotnet_/_dotnet_/_dotnet/_dotnet-install.sh -c Current")
