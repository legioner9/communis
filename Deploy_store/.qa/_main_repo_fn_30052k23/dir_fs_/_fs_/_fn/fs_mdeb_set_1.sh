#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_fs_/_fs_/_fn/fs_mdeb_set_1.sh"
...
fs_mdeb_set_1() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_fs_/_fs_/_fn/fs_mdeb_set_1.sh)
...
${NORMAL}"
    ...
    if ! wrp2_ cd --_xxd ${PATH_MAIN_REPO_FN_DIR}/dir_fs_/_fs_/_tmp; then
        return 1
    fi
