...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_gclone_/_gclone_/_default/default_deb.sh"
...
gclone_ --tml "${PATH_VAR_DIR}/git/hsc_alt/main.var" --name "tgu" -echo -verbose
