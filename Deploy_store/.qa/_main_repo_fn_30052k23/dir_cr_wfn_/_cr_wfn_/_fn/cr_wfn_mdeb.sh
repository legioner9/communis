#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_cr_wfn_/_cr_wfn_/_fn/cr_wfn_mdeb.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_cr_wfn_/_cr_wfn_/_fn/cr_wfn_mdeb.sh)
