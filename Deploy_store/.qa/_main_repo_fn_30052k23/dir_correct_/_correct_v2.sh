...
correct_() {
    ...
    *)
        ...
        res+=("echo ${HOME}/.vscode/extensions/dbankier.vscode-instant-markdown-1.4.7/node_modules/github-markdown-css/github-markdown.css")
        arr+=("vscode settings.json")
        res+=("echo ${HOME}/.vscode/settings.json")
        arr+=("english PHRASE")
        res+=("echo ${PATH_COMMUNIS}/Store/English_info/dictionary_phrase.man")
        arr+=(".tst PATH")
        ...
        arr+=("_dnf_ boot menu")
        res+=("echo ${PATH_COMMUNIS}/Deploy_store/.qa/menus/_set_menu/_mm_flow_/_mm_0_start_sys_/dnf_.sh")
        ...
        res+=("echo ${PATH_COMMUNIS}/Deploy_store/deploy_sistem")
        arr+=(".list2 for bd_communis_")
        res+=("echo ${PATH_COMMUNIS}/Deploy_store/plt_bd/list2")
        arr+=("_tmls to sys")
        res+=("echo ${PATH_MAIN_REPO_FN_DIR}/_tmls/")
        #15
        arr+=("prl.man")
        res+=("echo ${PATH_COMMUNIS}/Deploy_store/plt_bd/_exa_for_first_start/prl.man")
        arr+=(".canons/.cfnlist.md")
        res+=("echo ${PATH_CANONS_DIR}/.cfnlist.md")
        arr+=("latina/keywords.man")
        res+=("echo ${PATH_COMMUNIS}/Store/latina/keywords.man")
        arr+=("add_PATH_.lst")
        ...
        arr+=("repo Lexicon")
        res+=("echo ${HOME}/ProjectRepo_2/_repo/Lexicon")
        arr+=("flumen tempus .flu dir")
        res+=("echo ${PATH_FLUMEN_TEMPUS_DIR}")
        arr+=("vim tutorial")
        res+=("echo ${PATH_COMMUNIS}/Store/vim/Vim_учебник_ALT_Linux_Wiki.pdf")
        arr+=(".tml for cr_f_")
