...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_lib/_tst/set_c_tst_4_cpjs/exec.sh"
...
if [ -f main.bexe ]; then
    ...
    cd use/ || qq_pause
    echo -e "${BLUE}--- touch myfile.txt ---${NORMAL}" #sistem info mesage
    touch myfile.txt
