# 0 "lib/uni_1.c"
# 1 "${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/mipt/Clang/1.coffe_c/10_10_CoffeeFileStr/8_pic_rect_myvar_cpjs//"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 7 "lib/uni_1.c" 2
# 1 "/usr/lib/gcc/x86_64-redhat-linux/12/include/iso646.h" 1 3 4
# 8 "lib/uni_1.c" 2
...
# 99 "/usr/lib/gcc/x86_64-redhat-linux/12/include/stdarg.h" 3 4
...
# 55 "/usr/include/bits/cmathcalls.h" 3 4
...
# 103 "/usr/include/bits/cmathcalls.h" 3 4
...
# 179 "/usr/include/bits/socket.h" 3 4
# 1 "/usr/include/bits/sockaddr.h" 1 3 4
# 28 "/usr/include/bits/sockaddr.h" 3 4
typedef unsigned short int sa_family_t;
# 180 "/usr/include/bits/socket.h" 2 3 4
...
# 195 "/usr/include/bits/socket.h" 3 4
...
# 315 "/usr/include/bits/socket.h" 3 4
extern struct cmsghdr *__cmsg_nxthdr (struct msghdr *__mhdr,
          struct cmsghdr *__cmsg) __attribute__ ((__nothrow__ , __leaf__));
# 362 "/usr/include/bits/socket.h" 3 4
enum
  {
    SCM_RIGHTS = 0x01
...
# 384 "/usr/include/bits/socket.h" 3 4
...
# 385 "/usr/include/bits/socket.h" 2 3 4
...
# 444 "/usr/include/bits/fcntl-linux.h" 3 4
...
# 69 "lib/uni_1.c" 3 4
               stderr
# 69 "lib/uni_1.c"
                     , "from access_c pathname = %s,mode = %d errno = %d\n", path, amode, 
# 69 "lib/uni_1.c" 3 4
                                                                                          (*__errno_location ())
# 69 "lib/uni_1.c"
                                                                                               );
      ...
      int access_cb(int cb(char *, int), char *path, int amode)
{
    ...
    return a;
      ...
      int chdir_\U00000441(char *path, const char *file, const int line)
{
    int a = chdir(path);
    if (-1 == a)
    {
...
# 95 "lib/uni_1.c" 3 4
               stderr
# 95 "lib/uni_1.c"
                     , "from chdir_с pathname = %s, errno = %d\n", path, 
# 95 "lib/uni_1.c" 3 4
                                                                          (*__errno_location ())
# 95 "lib/uni_1.c"
                                                                               );
...
# 97 "lib/uni_1.c"
    ...
    return a;
      ...
      int chdir_\U00000441b(int cb(char *), char *path)
{
    int a = chdir(path);
    if (-1 == a)
    {
    ...
    return a;
      ...
      int chown_\U00000441(const char *path, uid_t owner, gid_t group, const char *file, const int line)
{
...
# 119 "lib/uni_1.c" 3 4
               stderr
# 119 "lib/uni_1.c"
                     , "from chown_с path = %s, owner = %d, owner = %d, errno = %d\n", path, owner, group, 
# 119 "lib/uni_1.c" 3 4
                                                                                                            (*__errno_location ())
# 119 "lib/uni_1.c"
                                                                                                                 );
...
# 121 "lib/uni_1.c"
    ...
    return a;
      ...
      int chown_\U00000441b(int cb(char *, uid_t, uid_t), char *path, uid_t owner, gid_t group)
{
    int a = chown(path, owner, group);
    if (-1 == a)
    {
    ...
    return a;
      ...
      int close_\U00000441(int fildes, const char *file, const int line, int st__mo, int st__if, int st__re)
{
...
# 227 "lib/uni_1.c"
      int dup_\U00000441(int oldfd, const char *file, const int line, int st__mo, int st__if, int st__re)
{
...
# 317 "lib/uni_1.c"
      pid_t fork_\U00000441(const char *file, const int line)
{
    pid_t a = fork();
    if (-1 == a)
    {
...
# 325 "lib/uni_1.c"
    ...
    return a;
      ...
      pid_t fork_\U00000441b(int cb(pid_t))
{
    pid_t a = fork();
    if (-1 == a)
    {
    ...
    return a;
      ...
      int fsync_\U00000441(int fildes, const char *file, const int line)
{
    int a = fsync(fildes);
    if (-1 == a)
    {
...
# 349 "lib/uni_1.c"
    ...
    return a;
      ...
      int fsync_\U00000441b(int cb(int), int fildes)
{
    int a = fsync(fildes);
    if (-1 == a)
    {
    ...
    return a;
      ...
      int getgroups_\U00000441(int gidsetsize, gid_t grouplist[], const char *file, const int line)
{
...
# 377 "lib/uni_1.c"
    ...
    return a;
      ...
      int getgroups_\U00000441b(int cb(void), int gidsetsize, gid_t grouplist[])
{
    int a = getgroups(gidsetsize, grouplist);
    if (-1 == a)
    {
    ...
    return a;
      ...
      int gethostname_\U00000441(char *name, size_t namelen, const char *file, const int line)
{
...
# 401 "lib/uni_1.c"
    ...
    return a;
      ...
      int gethostname_\U00000441b(int cb(void), char *name, size_t namelen)
{
    int a = gethostname(name, namelen);
    if (-1 == a)
    {
    ...
    return a;
      ...
      char *getlogin_\U00000441(const char *file, const int line)
{
    char *a = getlogin();
    if (
# 419 "lib/uni_1.c" 3 4
...
# 424 "lib/uni_1.c"
    ...
    return a;
      ...
      char *getlogin_\U00000441b(int cb())
{
    char *a = getlogin();
    if (
# 432 "lib/uni_1.c" 3 4
...
# 432 "lib/uni_1.c"
    ...
    return a;
      ...
      int getlogin_r_\U00000441(char *name, size_t namesize, const char *file, const int line)
{
...
# 447 "lib/uni_1.c"
    ...
    return a;
      ...
      int getlogin_r_\U00000441b(int cb(void), char *name, size_t namesize)
{
    int a = getlogin_r(name, namesize);
    if (0 != a)
    {
    ...
    return a;
      ...
      int getsid_\U00000441(pid_t pid, const char *file, const int line)
{
    int a = getsid(pid);
    if (-1 == a)
    {
...
# 475 "lib/uni_1.c"
    ...
    return a;
      ...
      int getsid_\U00000441b(int cb(pid_t), pid_t pid)
{
    int a = getsid(pid);
    if (-1 == a)
    {
    ...
    return a;
      ...
      off_t lockf_\U00000441(int fildes, int function, off_t size, const char *file, const int line)
{
...
# 501 "lib/uni_1.c" 3 4
               stderr
# 501 "lib/uni_1.c"
                     , "from lockf_с fildes = %d,function = %ld,size = %ld, errno = %d\n", fildes, function, size, 
# 501 "lib/uni_1.c" 3 4
                                                                                                                    (*__errno_location ())
# 501 "lib/uni_1.c"
                                                                                                                         );
...
# 503 "lib/uni_1.c"
    ...
    return a;
      ...
      off_t lockf_\U00000441b(int cb(int, int, off_t), int fildes, int function, off_t size)
{
    off_t a = lockf(fildes, function, size);
    if (-1 == a)
    {
    ...
    return a;
      ...
      int lseek_\U00000441(int fildes, off_t offset, int where, const char *file, const int line)
{
...
# 524 "lib/uni_1.c" 3 4
               stderr
# 524 "lib/uni_1.c"
                     , "from lockf_с fildes = %d,function = %d,size = %d, errno = %d\n", fildes, offset, where, 
# 524 "lib/uni_1.c" 3 4
                                                                                                                 (*__errno_location ())
# 524 "lib/uni_1.c"
                                                                                                                      );
...
# 526 "lib/uni_1.c"
    ...
    return a;
      ...
      int lseek_\U00000441b(int cb(int, off_t, int), int fildes, off_t offset, int where)
{
    int a = lseek(fildes, offset, where);
    if (-1 == a)
    {
    ...
    return a;
      ...
      ssize_t read_\U00000441(int fildes, void *buf, size_t nbyte, const char *file, const int line, int st__mo, int st__if, int st__re)
{
...
# 559 "lib/uni_1.c" 3 4
                       stderr
# 559 "lib/uni_1.c"
                             , "from read_с fildes = %d, nbyte = %ld, errno = %d\n", fildes, nbyte, 
# 559 "lib/uni_1.c" 3 4
                                                                                                     (*__errno_location ())
# 559 "lib/uni_1.c"
                                                                                                          );
...
# 612 "lib/uni_1.c"
int read_\U00000441b(int cb(int, size_t), int fildes, void *buf, size_t nbyte)
{
    ssize_t a = read(fildes, buf, nbyte);
    if (-1 == a)
    {
...
# 646 "lib/uni_1.c"
      int unlink_\U00000441(int fd, const char *file, const int line, int st__mo, int st__if, int st__re)
{
...
# 684 "lib/uni_1.c"
    ...
    else
    {
      ...
      int write_\U00000441(int fildes, const void *buf, size_t nbyte, const char *file, const int line, int st__mo, int st__if, int st__re)
{
