...
/*#*/ int prn_sockadr_bind_с(struct sockaddr *name, const char *file, const int line, int st__mo, int st__if, int st__re)
{
...
/*#*/ int prn_addr_from_socket_с(int socket, const char *file, const int line, int st__mo, int st__if, int st__re)
{
...
/*#*/ int prn_addr_in_from_name_с(struct sockaddr_in addr, const char *file, const int line, int st__mo, int st__if, int st__re)
{
