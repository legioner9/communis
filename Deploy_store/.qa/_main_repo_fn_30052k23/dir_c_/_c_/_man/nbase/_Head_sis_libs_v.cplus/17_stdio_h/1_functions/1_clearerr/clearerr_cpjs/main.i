# 0 "main.c"
# 1 "${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/_Head_sis_libs_v.cplus/17_stdio_h/1_functions/1_clearerr/clearerr_cpjs//"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "main.c" 2
# 1 "/usr/lib/gcc/x86_64-redhat-linux/11/include/iso646.h" 1 3 4
# 5 "main.c" 2
...
# 407 "/usr/include/bits/mathcalls.h" 3 4
...
int main(int argc, char const *argv[])
{
  ...
  pFile = fopen_c("myfile.txt", "r", "main.c", 27);
...
# 31 "main.c" 3 4
         stdout
# 31 "main.c"
               , " ftell_c(pFile) = %ld,ferror(pFile) = %d, errno = %d\n", ftell_c(pFile, "main.c", 31), ferror(pFile), 
# 31 "main.c" 3 4
                                                                                                                              (*__errno_location ())
# 31 "main.c"
                                                                                                                                   );
...
# 36 "main.c" 3 4
         stdout
# 36 "main.c"
               , " ftell_c(pFile) = %ld,ferror(pFile) = %d, errno = %d\n", ftell_c(pFile, "main.c", 36), ferror(pFile), 
# 36 "main.c" 3 4
                                                                                                                              (*__errno_location ())
# 36 "main.c"
                                                                                                                                   );
...
# 40 "main.c" 3 4
         stdout
# 40 "main.c"
               , " ftell_c(pFile) = %ld,ferror(pFile) = %d, errno = %d\n", ftell_c(pFile, "main.c", 40), ferror(pFile), 
# 40 "main.c" 3 4
                                                                                                                              (*__errno_location ())
# 40 "main.c"
                                                                                                                                   );
...
# 45 "main.c" 3 4
         stdout
# 45 "main.c"
               , " ftell_c(pFile) = %ld,ferror(pFile) = %d, errno = %d\n", ftell_c(pFile, "main.c", 45), ferror(pFile), 
# 45 "main.c" 3 4
                                                                                                                              (*__errno_location ())
# 45 "main.c"
                                                                                                                                   );
