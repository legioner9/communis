...
l2exl_() {
    ...
    local FNLOCK="fn: ${FNN}, with_args: $1, $2, $3 , filename: ${PATH_FN}/dir_${FNN}/${FNN}.sh, line: $LINENO"
...
${FNN} _deb, ${FNN} _mdeb
EXAMP:
 ${FNN} -_quod \${PATH_ARGS_DIR}/l2exl_/_quod/test.list -_exl \${PATH_ARGS_DIR}/l2exl_/_exl/test.exl
${NORMAL}"
        return 0
    fi
    #{cntl_help}
