#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_l2exl_/_l2exl_/_fn/l2exl_mdeb.sh"
...
l2exl_mdeb() {
    ...
    local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_l2exl_/_l2exl_/_fn/l2exl_mdeb.sh)
...
${NORMAL}"
    ...
    arr+=("leave menu")
    res+=("echo bye)))")
    arr+=("${FNN}_set_1: test create dirs in root dir")
    res+=("${FNN}_set_1")
    #{arr_res}
    # arr+=("aaaaaaaaa")
    # res+=("bbbbbbbbb")
