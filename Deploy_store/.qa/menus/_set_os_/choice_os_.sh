...
filename="$PATH_OS/.qa/menus/_set_os_/choice_os_.sh"
...
choice_os_(){
    echo -e "${CYAN}---choice_os_() $*---${NORMAL}" #started functions
    
    c_up "$PATH_OS/.qa/menus/_set_os_/_choice_os_"
    ...
    case $dilectus in
        ...
        "${arr[2]}")
            ...
            c_up "$PATH_OS/.qa/menus/_set_menu_ubuntu"
            ${res[2]}
            choice_os_ "$@"
        ;;
