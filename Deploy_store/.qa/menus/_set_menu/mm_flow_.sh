...
filename="$PATH_OS/.qa/menus/_set_menu/mm_flow_.sh"
...
mm_flow_() {
    ...
    c_up "$PATH_OS/.qa/menus/_set_menu/_mm_flow_"
    ...
    res+=("mm_1_conq")
    arr+=("mm_2_catalog_ - catalog all utils ")
    res+=("mm_2_catalog_")
    arr+=("mm_3_perpetuo_ - all allways flow")
    res+=("mm_3_perpetuo_")
