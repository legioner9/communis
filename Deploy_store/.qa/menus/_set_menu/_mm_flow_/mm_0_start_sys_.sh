...
filename="$PATH_OS/.qa/menus/_set_menu/_mm_flow/mm_0_start_sys.sh"
...
mm_0_start_sys(){
    ...
    c_up "$PATH_OS/.qa/menus/_set_menu/_mm_flow_/_mm_0_start_sys_"
    path_man_1="$PATH_OS/.qa/menus/_set_menu/_mm_flow_/_mm_0_start_sys_/_man_1"
    ...
    res+=("sys_info_")
    arr+=("snap_ - snap install and packages")
    res+=("snap_")
    arr+=("rpm_ - rpm util")
    res+=("rpm_")
    arr+=("flatpak_ - flatpak package management")
    res+=("flatpak_")
    #10
