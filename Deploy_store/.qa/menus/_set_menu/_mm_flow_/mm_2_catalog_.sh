...
filename="$PATH_OS/.qa/menus/_set_menu/_mm_flow_/mm_2_catalog_.sh"
...
mm_2_catalog_(){
    echo -e "${CYAN}---mm_2_catalog_() $*---${NORMAL}" #started functions
    
    c_up "$PATH_OS/.qa/menus/_set_menu/_mm_flow_/_mm_2_catalog_/"
    path_man_1="$PATH_OS/.qa/menus/_set_menu/_mm_flow_/_mm_2_catalog_/_man_1"
    ...
    arr+=("text_to_console_ - common ->text_to_console ")
    res+=("text_to_console_")
