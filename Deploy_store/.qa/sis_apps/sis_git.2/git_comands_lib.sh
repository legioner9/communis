...
filename="$PATH_OS/.qa/sis_git.2/git_comands_lib.sh"
...
git_pull() {
    ...
    echo -e "${CYAN}---git_pull() $.1=$1 $.2=$2 $.3=$3---${NORMAL}" #started functions
...
git_push() {
    ...
    echo -e "${CYAN}---git_push() $.1=$1 $.2=$2 $.3=$3---${NORMAL}" #started functions
