...
pre_push() { # $1=$repo_path $2=$did
    ...
    echo -e "${ULINE}cp -rf "$PATH_OS/.os" "$1/_repo/$name_this_repo/Sis_USER/$2/"${NORMAL}" #repit commands
    cp -rf "$PATH_OS/.os" "$1/_repo/$name_this_repo/Sis_USER/$2/"

    echo -e "${ULINE}rm -rf "$1/_repo/$name_this_repo/Sis_USER/$2/.qa"${NORMAL}" #repit commands
    rm -rf "$1/_repo/$name_this_repo/Sis_USER/$2/.qa"

    echo -e "${ULINE}cp -rf "$PATH_OS/.qa" "$1/_repo/$name_this_repo/Sis_USER/$2/"${NORMAL}" #repit commands
    cp -rf "$PATH_OS/.qa" "$1/_repo/$name_this_repo/Sis_USER/$2/"
