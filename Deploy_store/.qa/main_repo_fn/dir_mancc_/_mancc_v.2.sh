...
mancc_() {
    ...
    *)
        ...
        manpath=/home/st/$(cat ${PATH_MAIN_REPO_FN_DIR}/dir_mancc_/mancc_.list)
        ...
        mancc_prn_all_item_dir() {
            ...
            for param in ${arr_params[@]}; do
                ...
                dd2e $manpath$(p2name_mancc_ $param)s 2>/dev/null
        ...
        mancc_prn_res_grep() { # $1 mach
            ...
            for name_path in $(mancc_prn_all_item_dir); do
                if grep -q $1 <<<$name_path; then
                    echo $name_path
                fi
            done
        }
        ...
        prs_f -ne $dilectus
        echo $dilectus/"$(prs_f -ne $dilectus)".md
        ...
        # ${PATH_MAIN_REPO_FN_DIR}/dir_cr_man_h_unix_/_cr_man_h_unix_/_debug/v.4/structs/sembuf/sembuf.man
