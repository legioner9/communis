...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_s_e_/s_e_.sh"
    ...
    *)
        ...
        select item in "${arr[@]}"; do
            ...
            case $dilectus in
               ...
               "word")
                    echo -e "${CYAN}---word mode---${NORMAL}" #started functions
                    s_w_
                    $FNN
                ;;
                
               "md")
                    echo -e "${CYAN}---md mode---${NORMAL}" #started functions
                    s_md_
                    $FNN
                ;;
                
               "tag")
                    echo -e "${CYAN}---tag mode---${NORMAL}" #started functions
                    s_s_
                    $FNN
                ;;
