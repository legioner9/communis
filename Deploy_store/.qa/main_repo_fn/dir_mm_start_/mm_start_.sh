...
EXAMP:${NORMAL}"
    ...
    arr+=("upgrade rvm")
    res+=("rvm get head")
    arr+=("virtualbox_add_user_")
    res+=("virtualbox_add_user_")
    arr+=("add USER to docker group")
    res+=("add_user_to_docker_")
    arr+=("start docker")
    res+=("start_docker_")
    arr+=("start flameshot")
    ...
    arr+=("mate-disk-usage-analyzer")
    res+=("mate-disk-usage-analyzer")
    # arr+=("aaaa")
    # res+=("bbbbb")
    # arr+=("aaaa")
    # res+=("bbbbb")
