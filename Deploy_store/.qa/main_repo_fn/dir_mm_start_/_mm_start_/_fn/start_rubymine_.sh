#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_CURR_REPO}/communis/Deploy_store/.qa/main_repo_fn/dir_mm_start_/_mm_start_/_fn/start_rubymine_.sh"
...
start_rubymine_() {
    ...
    local d_name=$(dirname ${PATH_CURR_REPO}/communis/Deploy_store/.qa/main_repo_fn/dir_mm_start_/_mm_start_/_fn/start_rubymine_.sh)
