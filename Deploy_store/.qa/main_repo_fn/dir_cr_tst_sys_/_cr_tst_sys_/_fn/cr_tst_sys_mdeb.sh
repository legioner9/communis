#!/bin/bash
#. "/home/st/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_cr_tst_sys_/_cr_tst_sys_/_fn/cr_tst_sys_mdeb.sh"
...
cr_tst_sys_mdeb() {
    ...
    d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_cr_tst_sys_/_cr_tst_sys_/_fn/cr_tst_sys_mdeb.sh)
...
${NORMAL}"
    ...
    cr_tst_sys_mdeb_set1() {
        ...
        rr_
        local tmp=${PATH_MAIN_REPO_FN_DIR}/dir_cr_tst_sys_/_cr_tst_sys_/_tmp
