...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_add_tag_nm_/add_tag_nm_.sh"
...
add_tag_nm_() {
    ...
    local ORIGO_DIR=${PATH_MAIN_REPO_FN_DIR}/dir_add_tag_nm_
    local PPWD=$PWD
    local FLN=$0
    local ARGS=($@)
    ...
    *)
        ...
        unset _f2a_
        f2a "${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_config/mane_$1.tag"
        ...
        if [ -z $flag ]; then
            ...
            if_f_h "${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_config/mane_$1.tag"
            echo "$f_tag" >>"${PATH_MAIN_REPO_FN_DIR}/dir_$1/_$1/_config/mane_$1.tag"
        else
            echo -e "${BLUE}---find---${NORMAL}" #sistem info mesage
            qq_pause "${BLUE}---$f_tag  allready in tags---${NORMAL}"
            echo "bye)))"
        fi
        # echo "$adds" > "${PATH_MAIN_REPO_FN_DIR}/dir_hh_/_hh_/_config/mane_hh_.tag"

        unset _f2a_

        # less ${PATH_MAIN_REPO_FN_DIR}/dir_hh_/_hh_/_config/mane_hh_.tag
