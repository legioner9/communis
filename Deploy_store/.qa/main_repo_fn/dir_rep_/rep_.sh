...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_rep_/rep_.sh"
...
rep_() {
    ...
    *)
        ...
        #!function body======================
            ...
            arr+=("leave menu")
            res+=("echo bye)))")
            arr+=("repair BAG makefiles gcc in usr/lib/gcc/x86_64-redhat-linux cp -rf 12/ 11/")
            res+=("")
            ...
            case $dilectus in
                ...
                "${arr[1]}")
                    ...
                    cd usr/lib/gcc/x86_64-redhat-linux || qq_exit
                    sudo cp -rf 12/ 11/
                    rep_ "$@"
                ;;
