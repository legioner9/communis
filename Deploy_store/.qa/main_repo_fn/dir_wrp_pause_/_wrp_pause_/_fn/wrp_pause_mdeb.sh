#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_wrp_pause_/_wrp_pause_/_fn/wrp_pause_mdeb.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_wrp_pause_/_wrp_pause_/_fn/wrp_pause_mdeb.sh)
