...
#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_mm_sis_tips_/_mm_sis_tips_/_fn/mm_sis_tips_mdeb.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_mm_sis_tips_/_mm_sis_tips_/_fn/mm_sis_tips_mdeb.sh)
