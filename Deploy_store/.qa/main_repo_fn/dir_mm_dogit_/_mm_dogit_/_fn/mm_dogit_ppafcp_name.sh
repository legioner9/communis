...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_mm_dogit_/_mm_dogit_/_fn/mm_dogit_ppafcp_name.sh"
...
mm_dogit_ppafcp_name() {
    echo -e "${CYAN}--- ${FUNCNAME[0]}() $* ---${NORMAL}" #started functions

    garg_ ${FUNCNAME[0]} $@ 1>/dev/null

    d_name=$(dirname "/home/st"/communis/Deploy_store/.qa/main_repo_fn/dir_mm_dogit_/_mm_dogit_/_fn/mm_dogit_ppafcp_name.sh)
    ...
    # exl_ --list "${PATH_EXL_DIR}/git/dogit_ppafcp.exl" &>${PATH_MAIN_REPO_FN_DIR}/dir_mm_dogit_/_mm_dogit_/_out/exl_.res
    #*--------------------------------------------------------------------------------------------------------------------------
