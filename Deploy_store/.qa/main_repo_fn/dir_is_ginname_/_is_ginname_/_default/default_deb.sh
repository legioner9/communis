...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_is_ginname_/_is_ginname_/_default/default_deb.sh"
...
is_ginname_ --tml "${PATH_VAR_DIR}/git/hsc_alt/main.var" --name "tgu" -echo -debug

echo -e "${RED}--- $? ---${NORMAL}" #exit 1

cd
is_ginname_ --tml "${PATH_VAR_DIR}/git/hsc_alt/main.var" --name "tgu"
