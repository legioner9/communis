#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_CURR_REPO}/communis/Deploy_store/.qa/main_repo_fn/dir_cr_shfn_/cr_shfn_tst/_e.sh"
...
local d_name=$(dirname ${PATH_CURR_REPO}/communis/Deploy_store/.qa/main_repo_fn/dir_cr_shfn_/cr_shfn_tst/_e.sh)
