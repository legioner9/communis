...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_exl_/_exl_/_debug/if_exl/with_fif.sh"
...
cd ${PATH_MAIN_REPO_FN_DIR}/dir_exl_/_exl_/_debug/if_exl

exl_ --list ${PATH_MAIN_REPO_FN_DIR}/dir_exl_/_exl_/_debug/if_exl/this_with_fif.list
