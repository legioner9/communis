...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/f_f_fonsh_.sh"
...
f_f_fonsh_() {
    ...
    if [ "-h" == "$1" ]; then
        echo -e "${CYAN} ${FUNCNAME[0]}() help: 
            ...
            DEBUG: f_f_ _mdeb
            EXAMP: 
                echo | f_f_ est_ --ratis \${PATH_MAIN_REPO_FN_DIR}
    ...
    *)
        ...
        wrp_fifs1_ cd ${FONSH_PATH}/actio -d1
        ...
        #! be created cr_tst_dir_ --name "$1"tst --ext tst (wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/)
        ...
        rts_fn=${FONSH_PATH}/actio

        cr_f_ "$PWD/dir_$1/$1.sh" --vi0 ${rts_fn} --vr0 {rts_fn}
        upg_path_ "$PWD/dir_$1/$1.sh"

        #* work in _debug >>>>>>>>>>
        wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/_$1/_debug/v1 -d1
        cr_sh_ deb_1.sh
        wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/_$1/_debug/self_tst -d1
        cr_sh_ self_tst_1.sh
        wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/_$1/_debug -d1
        cr_sh_ mdeb.sh

        #? _fn/$1_mdeb.sh
        file_path=${FONSH_PATH}/actio/dir_$1/_$1/_fn/$1mdeb.sh
        ...
        #? _fn/$1_mdeb_set_1.sh
        file_path=${FONSH_PATH}/actio/dir_$1/_$1/_fn/$1mdeb_set_1.sh
        ...
        file_path=${FONSH_PATH}/actio/dir_$1/_$1/_debug/self_tst/self_tst_1.sh
        ...
        edit_ "${FONSH_PATH}/actio/dir_$1"

        . ${FONSH_PATH}/actio/dir_$1/_$1/_debug/self_tst/self_tst_1.sh
        #* work in _debug <<<<<<<<<<

        #* work in extst >>>>>>>>>>
        wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/ -d1
        ...
        #! be created cr_tst_dir_ --name "$1"tst --ext tst (wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/)
        wrp_fifs1_ mkdir ${FONSH_PATH}/actio/dir_$1/$1tst -cnd1
        wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/$1tst -d1
        cr_tst_dir_ --name "$1"tst --ext tst

        #* work in extst <<<<<<<<<<

        #* work in _default >>>>>>>>>>
        wrp_fifs1_ cd ${FONSH_PATH}/actio/dir_$1/_$1/_default -d1
        cr_sh_ default_deb.sh

        file_path=${FONSH_PATH}/actio/dir_$1/_$1/_default/default_deb.sh
