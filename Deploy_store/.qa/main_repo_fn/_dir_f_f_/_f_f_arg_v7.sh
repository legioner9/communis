...
f_f_arg_() {
    ...
    # cp_h "$ORIGO_DIR/_f_f_/_tml/f_f_" "$PWD/dir_${name_fn_}/${name_fn_}.sh" "$filename" "$LINENO"
    ...
    wrp2_ cp -rf --_xxd "$ORIGO_DIR/_f_f_/_tml/_00000" --_xnf "$PWD/dir_${name_fn_}/_${name_fn_}"

    #! be created cr_tst_dir_ --name "${name_fn_}"tst --ext tst (wrp_fifs1_ cd ${dir_fns_}/dir_${name_fn_}/)
    # cp_h "$ORIGO_DIR/_f_f_/_tml/_tst" "$PWD/dir_${name_fn_}/${name_fn_}tst/"

    # wrp2_ mv --_xxf "${PATH_MAIN_REPO_FN_DIR}/dir_${name_fn_}/_${name_fn_}/_config/mane_.tag" --_xnf "${PATH_MAIN_REPO_FN_DIR}/dir_${name_fn_}/_${name_fn_}/_config/mane_${name_fn_}.tag"
    # wrp2_ mv --_xxf ${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/_f_f_/_debug/v1/dir_fns/dir_fff_arg_/_fff_arg_/_config/mane_.tag --_xnf "${PATH_MAIN_REPO_FN_DIR}/dir_${name_fn_}/_${name_fn_}/_config/mane_${name_fn_}.tag"
    ...
    # sed -i 's/00000/'${name_fn_}'/g' "$PWD/dir_${name_fn_}/${name_fn_}.sh"
    wrp2_ cr_f_ --_xxf ${PWD}/dir_${name_fn_}/${name_fn_}.sh --vi0 ${name_fn_} --vr0 {name_fn_}

    # sed -i 's/00000/'${name_fn_}'/g' "$PWD/dir_${name_fn_}/${name_fn_}tst/exec._tst"
    wrp2_ cr_f_ --_xxf $PWD/dir_${name_fn_}/${name_fn_}tst/exec._tst --vi0 ${name_fn_} --vr0 {name_fn_}

    # sed -i 's/00000/'${name_fn_}'/g' "$PWD/dir_${name_fn_}/${name_fn_}tst/_flow_tst.sh"
    wrp2_ cr_f_ --_xxf $PWD/dir_${name_fn_}/${name_fn_}tst/_flow_tst.sh --vi0 ${name_fn_} --vr0 {name_fn_}

    #? insert {rts_fn} in main fn file
    #! hardcord rts_fn=${"${PATH_MAIN_REPO_FN_DIR}"}
    rts_fn=${dir_fns_}

    cr_f_ "$PWD/dir_${name_fn_}/${name_fn_}.sh" --vi0 ${rts_fn} --vr0 {rts_fn}
    upg_path_ "$PWD/dir_${name_fn_}/${name_fn_}.sh"

    #* work in _debug >>>>>>>>>>
    wrp_fifs1_ cd ${dir_fns_}/dir_${name_fn_}/_${name_fn_}/_debug/v1 -d1
    cr_sh_ deb_1.sh
    wrp_fifs1_ cd ${dir_fns_}/dir_${name_fn_}/_${name_fn_}/_debug/self_tst -d1
    cr_sh_ self_tst_1.sh
    wrp_fifs1_ cd ${dir_fns_}/dir_${name_fn_}/_${name_fn_}/_debug -d1
    cr_sh_ mdeb.sh
