...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_f_f_/_f_f_/_debug/v1/dir_fns/dir_fff_arg_/fff_arg_.sh"
...
#{see_cntl}
exit_err_fff_arg_() { #* $1 error message
local arg1="$1"
unset_autoargs_fff_arg_
...
# >${FN_OUT_DIR}/com_fff_arg_.res
# COMMAND &>>${FN_OUT_DIR}/com_fff_arg_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_fff_arg_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_fff_arg_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_fff_arg_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
