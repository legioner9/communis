...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/all_man_files_.sh"
...
all_man_files_() {
    ...
    *)
        ...
        cd_h "${PATH_MAIN_REPO_FN_DIR}" "$filename" "$LINENO"
        # cd_h "${PATH_MAIN_REPO_FN_DIR}/dir_s_t_/_s_t_/_man" "$filename" "$LINENO"

        echo -e "${BLUE}---cat /dev/null---${NORMAL}" #sistem info mesage
        cat /dev/null >"${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/_all_man_files_/_out/_res.res"
        cat /dev/null >"${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/_all_man_files_/_out/_res_md.res"
        ...
        recurs_() {
            for item in *; do
                if [ -d "$PWD/$item" ]; then
                    ...
                    if [ "${item##*.}" = "man" ]; then
                        echo -e "${GREEN}\$item = $item${NORMAL}" #print variable
                        echo "$PWD/$item" >>"${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/_all_man_files_/_out/_res.res"
                        grep "^#" "$PWD/$item" | sed 's|^|'"$PWD/$item^^^"'|' >>"${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/_all_man_files_/_out/_res_md.res"
                    fi
        ...
        # PM="${PATH_MAIN_REPO_FN_DIR}/dir_bash_/_bash_/_man/paradigm.man"

        # grep "^#" "$PM"  >> "${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/_all_man_files_/_out/_res_md.res"

        # grep "^#" "$PM" | sed  's|^|'"$PM^^^"'|' >> "${PATH_MAIN_REPO_FN_DIR}/dir_all_man_files_/_all_man_files_/_out/_res_md.res"

        #  "${PATH_MAIN_REPO_FN_DIR}/dir_bash_/_bash_/_man/paradigm.man"
        #!function body======================
        #!function body===============================================
        #!function body===================================================================
