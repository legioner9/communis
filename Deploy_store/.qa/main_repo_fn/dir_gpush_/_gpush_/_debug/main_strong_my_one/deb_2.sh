...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_gpush_/_gpush_/_debug/main_strong_my_one/deb_2.sh"
...
echo | gpush_ --tml "${PATH_MAIN_REPO_FN_DIR}/dir_gpush_/_gpush_/_debug/main_strong_my_one/main_strong_my_one.var" --name "tgu"
#{body}
#-------------------------------
#-------------------------------------
#----------------------------------------------------------------------
