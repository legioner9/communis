#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_mm_pg_/_mm_pg_/_fn/mm_pg_mdeb_set_1.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_mm_pg_/_mm_pg_/_fn/mm_pg_mdeb_set_1.sh)
