...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_s_a_/s_a_.sh"
...
s_a_() {
    ...
    *)
        ...
        # lockalENV s_a_={_result_}

        s_fn_S_a_ # all fn_dir _result_[i]=${PATH_MAIN_REPO_FN_DIR}/dir_$FN
        re_S_a_() {
            # lockalENV recurse_={_ch_type_s_}
            ch_type_s_L # word or tag
            sh_S_a_   # sh
            se_S_a_
        }

        se_S_a_L() {
            # lockalENV seer_={_ch_type_se_}
            ch_type_se_L
            ques_ re_S_a_L
        }
        recurse_
        is_S_a_L() {
            # lockalENV issuer_={_ch_type_i_}
            ch_type_i_L
            is_0_S_a_L
