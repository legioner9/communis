...
correct_() {
    ...
    *)
        ...
        arr+=("_dnf_ boot menu")
        res+=("echo file://${COMMUNIS_PATH}/Deploy_store/.qa/menus/_set_menu/_mm_flow_/_mm_0_start_sys_/dnf_.sh")
        ...
        res+=("echo file://${COMMUNIS_PATH}/Deploy_store/deploy_sistem")
        arr+=(".list2 for bd_communis_")
        res+=("echo file://${COMMUNIS_PATH}/Deploy_store/plt_bd/list2")
        arr+=("_tmls to sys")
        res+=("echo file://${PATH_MAIN_REPO_FN_DIR}/_tmls/")
        #15
        arr+=("prl.man")
        res+=("echo file://${COMMUNIS_PATH}/Deploy_store/plt_bd/_exa_for_first_start/prl.man")
        arr+=(".canons/.cfnlist.md")
        res+=("echo file://${PATH_CANONS_DIR}/.cfnlist.md")
        arr+=("latina/keywords.man")
        res+=("echo file://${COMMUNIS_PATH}/Store/latina/keywords.man")
        arr+=("add_PATH_.lst")
        ...
        arr+=("vim tutorial")
        res+=("echo file://${COMMUNIS_PATH}/Store/vim/Vim_учебник_ALT_Linux_Wiki.pdf")
        arr+=(".tml for cr_f_")
