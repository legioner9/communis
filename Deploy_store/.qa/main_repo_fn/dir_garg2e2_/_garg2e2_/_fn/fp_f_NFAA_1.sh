#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_MAIN_REPO_FN_DIR}/dir_garg2e2_/_garg2e2_/_fn/fp_f_NFAA_1.sh"
...
local d_name=$(dirname ${PATH_MAIN_REPO_FN_DIR}/dir_garg2e2_/_garg2e2_/_fn/fp_f_NFAA_1.sh)
