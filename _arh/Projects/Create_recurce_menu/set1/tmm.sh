...
# PPWD=$(pwd) home/st -> $HOME
# 00000=$1 menus name
# num=$2 reestrs menu number 
# name_fn=mm_$num_$00000_
# name_file=mm_$num_$00000_.sh

filename="$PPWD/$name_fn"_

echo -e "${HLIGHT}---start file: $filename---${NORMAL}" # start file

name_fn(){
    echo -e "${CYAN}---name_fn() $*---${NORMAL}" #started functions

    # mkdir "$PPWD"/_"$name_fn"_
    # c_up "$PPWD"/_"$name_fn"_
